        ...
        (n = function() {
              ...
              t: for (var o in e) {
                ...
                t.isUndef(u) ||
                  ...
                  (t.Param && u instanceof t.Param)
                    ? u.value !== i &&
                      (t.isUndef(n) ? (u.value = i) : u.rampTo(i, n))
                    : u instanceof AudioParam
                      ? u.value !== i && (u.value = i)
                      : t.TimeBase && u instanceof t.TimeBase
                        ? (r[o] = i)
                        : u instanceof t
                          ? u.set(i)
                          : u !== i && (r[o] = i));
                  ...
                  : t.Signal && u instanceof t.Signal
                    ...
                    : t.Param && u instanceof t.Param
                      ...
                      : u instanceof AudioParam
                        ...
                        : u instanceof t
                          ? (r[s] = u.get())
                          : !t.isFunction(u) && t.isDefined(u) && (r[s] = u);
              }
              return i;
            }),
          ...
          return (
            Object.defineProperty(t, "context", {
              ...
              set: function(i) {
                (e =
                  t.Context && i instanceof t.Context ? i : new t.Context(i)),
            ...
            return (
              ...
              Object.defineProperty(t.Oscillator.prototype, "type", {
                ...
                set: function(e) {
                  ...
                  if (0 === this._phase && i)
                    (this._wave = null),
                      null !== this._oscillator && (this._oscillator.type = e);
                  else {
          ...
          (s = function(t) {
            (t.Context = function() {
              ...
              (t.Context.prototype.resume = function() {
                return "running" !== this._context.state &&
        ...
        void 0 ===
          (s = function(t) {
            return (
              ...
              (t.BufferSource.prototype.start = function(e, i, n, s) {
                this.log("start", e, i, n, s),
                  this.assert(
                    -1 === this._startTime,
                ...
                if (
                  (o > 0
                    ? (this._gainNode.gain.setValueAtTime(0, e),
                      "linear" === this.curve
                        ? this._gainNode.gain.linearRampToValueAtTime(s, e + o)
        ...
        void 0 ===
          (s = function(t) {
            if (t.supported) {
              ...
              try {
                var s = i.decodeAudioData(n);
                s && t.isFunction(s.then) && (e = !0);
              } catch (t) {
                e = !1;
              }
              e ||
            ...
            return (
              ...
              (t.Envelope.prototype._setCurve = function(e, i, n) {
                if (t.Envelope.Type.hasOwnProperty(n)) {
                  var s = t.Envelope.Type[n];
                  t.isObject(s) ? (this[e] = s[i]) : (this[e] = s);
                } else {
                  if (!t.isArray(n))
              ...
              (t.Envelope.prototype.triggerAttack = function(e, i) {
                ...
                if ("linear" === this._attackCurve)
                  ...
                  for (var r = this._attackCurve, a = 1; a < r.length; a++)
                    if (r[a - 1] <= o && o <= r[a]) {
                      (r = this._attackCurve.slice(a))[0] = o;
                      break;
                    }
                ...
                if (s) {
                  ...
                  this.log("decay", h),
                    "linear" === this._decayCurve
                      ? this._sig.linearRampTo(l, s, h)
                      : "exponential" === this._decayCurve &&
                        this._sig.exponentialApproachValueAtTime(l, h, s);
                }
                return this;
              }),
            ...
            return (
              ...
              (t.TickSource.prototype.forEachTickBetween = function(e, i, n) {
                ...
                if (
                  ...
                  0 !== r && (r = 1 - r);
                  for (
                    var a = this.frequency.getTimeOfTick(o + r), l = null;
                    a < i && this._state;
              ...
              (t.TimeBase.prototype.valueOf = function() {
                ...
                if (t.isString(this._val) && t.isUndef(this._units)) {
                  ...
                  for (var n in this._val) {
                    var s = this._val[n];
                    i += new this.constructor(n).valueOf() * s;
                  }
                  return i;
                }
            ...
            return (
              ...
              (t.Player.prototype._start = function(e, i, n) {
                (i = this._loop
                  ...
                  : t.defaultArg(i, 0)),
                  (i = this.toSeconds(i));
                var s = t.defaultArg(n, Math.max(this._buffer.duration - i, 0));
                (s = this.toSeconds(s)),
                ...
                return (
                  ...
                  this._loop && t.isUndef(n)
                    ? o.start(e, i)
                    : o.start(e, i, s - this.toSeconds(this.fadeOut)),
                  this
                );
              }),
                            ...
                            : e === t.CtrlPattern.Type.RandomOnce
                              ...
                              : e === t.CtrlPattern.Type.AlternateUp
                                ? (this._direction === t.CtrlPattern.Type.Up
                                    ? ((this.index += 2),
                                      (this._direction =
                                        t.CtrlPattern.Type.Down))
                                    : ((this.index -= 1),
                                      (this._direction =
                                        t.CtrlPattern.Type.Up)),
                                  this.index >= this.values.length &&
                                    ((this.index = 0),
                                    (this._direction = t.CtrlPattern.Type.Up)))
            ...
            return (
                ...
                for (var s = 0; s < e.length; s++) {
                  ...
                  if (null !== r) {
                    ...
                    u.start(i, 0, l.duration / h, n),
                      t.isArray(this._activeSources[o]) ||
                        (this._activeSources[o] = []),
                      this._activeSources[o].push({ note: o, source: u });
                  }
                }
                return this;
              }),
              (t.Sampler.prototype.triggerRelease = function(e, i) {
                ...
                for (var n = 0; n < e.length; n++) {
                  var s = t.Frequency(e[n]).toMidi();
                  if (this._activeSources[s] && this._activeSources[s].length) {
                    var o = this._activeSources[s].shift().source;
                    (i = this.toSeconds(i)), o.stop(i);
                  }
                }
                return this;
              }),
              ...
              (t.Sampler.prototype.triggerAttackRelease = function(e, i, n, s) {
                if (
                  ((n = this.toSeconds(n)),
            ...
            return (
              ...
              (t.PolySynth.prototype.triggerAttack = function(t, e, i) {
                return (
                  ...
                  t.forEach(
                    function(t) {
                      this._getClosestVoice(e, t).triggerAttack(t, e, i);
                    }.bind(this)
                  ),
                  this
                );
              ...
              (t.PolySynth.prototype.triggerRelease = function(t, e) {
                return (
                  ...
                  t.forEach(
                    function(t) {
                      this._getClosestVoice(e, t).triggerRelease(e);
                    }.bind(this)
                  ),
                  this
                );
